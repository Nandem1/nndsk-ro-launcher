...
| D7VK deployment/release                        | **DEFERRED:** falta artifact y prueba side-by-side/prefix                                                                     | no existe consumidor productivo                 | roadmap spike 6A                              | ningún variant en F1                      | ADR-005                             |
