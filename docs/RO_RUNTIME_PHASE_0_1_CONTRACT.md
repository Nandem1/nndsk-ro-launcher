...
| ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- | --------------------------------------------- | ----------------------------------------- | ----------------------------------- |
| GraphicsProfile variants F1                    | Sólo `Dxvk`, `DgVoodooDxvk`                                                                                                   | Son las dos topologías reales                   | booleans/env y dgVoodoo actuales              | enum cerrado; no D7VK                     | ADR sustituto con autorización nueva |
...
| D7VK deployment/release                        | **CERRADO:** spike 6A fijó pin v2.2 y harness; ADR-005 `no-go` (Gepard `illegal file ddraw.dll`); 6B prohibida              | no existe consumidor productivo                 | `d7vk_spike.rs` + ADR-005                   | ningún variant en F1                      | ADR-005 (`no-go`)                       |
...
| 12. D7VK reclama `ddraw.dll` de dgVoodoo             | caso de caracterización del seam; ADR-005 `no-go`, sin variant productivo                      |
